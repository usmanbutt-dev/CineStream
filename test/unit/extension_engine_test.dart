/// Unit tests for the CineStream extension engine.
///
...
import 'package:cinestream/extensions/api/bridge_functions.dart';
import 'package:cinestream/extensions/models/extension_manifest.dart';
...
void main() {
  group('BridgeFunctions', () {
    ...
    test('cryptoBase64Encode/Decode round-trip', () {
      const original = 'CineStream test string';
