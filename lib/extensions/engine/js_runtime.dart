/// CineStream — QuickJS runtime wrapper.
///
...
class JsRuntime {
  ...
  Future<ExtensionMediaDetail> getDetail(String animeId) async {
    _ensureLoaded();
  ...
  ExtensionMediaDetail _parseDetailResponse(String json) {
    try {
      final data = jsonDecode(json) as Map<String, dynamic>;
