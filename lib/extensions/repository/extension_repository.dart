/// CineStream — Extension repository (install, update, remove, load).
///
...
class ExtensionRepository {
  ...
  Future<void> init() async {
    ...
    _extensionsDir = Directory(p.join(appDir.path, 'CineStream', 'extensions'));
  ...
  /// Looks for a `CineStream-extensions/extensions/` sibling directory
  ...
  Future<void> _syncDevExtensions() async {
    try {
      ...
      const devPaths = [
        '../CineStream-extensions/extensions',
      ];
  ...
  Future<ExtensionMediaDetail?> getDetail(
    String extensionId,
    String animeId,
  ) async {
