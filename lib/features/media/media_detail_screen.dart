/// CineStream — Anime Detail screen.
///
      ...
      return Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: [
              const Icon(Icons.error_outline, size: 48, color: CineColors.error),
...
class _DetailAppBar extends StatelessWidget {
  final ExtensionMediaDetail detail;
...
class _StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = isAiring ? CineColors.success : CineColors.info;
