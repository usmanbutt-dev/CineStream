/// CineStream — Video Player screen.
///
...
class VideoPlayerScreen extends ConsumerStatefulWidget {
  ...
  final ExtensionMediaDetail? animeDetail;
            ...
            children: [
              ...
              ListTile(
                leading: Icon(
                  ...
                  color: selectedSubtitle == null ? CineColors.primary : null,
                ),
                ...
                (sub) => ListTile(
                  leading: Icon(
                    sub == selectedSubtitle
                        ? Icons.radio_button_checked_rounded
                        : Icons.radio_button_off_rounded,
                    color: sub == selectedSubtitle ? CineColors.primary : null,
                  ),
                  title: Text(sub.lang),
                  onTap: () {
                    Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const CircularProgressIndicator(color: CineColors.primary),
