  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: tasksAsync.when(
        ...
        error: (e, _) => Center(
          child: Text('Error: $e',
              style: const TextStyle(color: CineColors.error)),
        ),
        data: (tasks) {
                      ...
                      Positioned(
                        ...
                        child: Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 6, vertical: 3),
                          decoration: BoxDecoration(
                            color: CineColors.info.withValues(alpha: 0.9),
                            borderRadius: BorderRadius.circular(4),
                          ),
                          child: const Row(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 6, vertical: 3),
                          decoration: BoxDecoration(
                            color: CineColors.error.withValues(alpha: 0.9),
                            borderRadius: BorderRadius.circular(4),
                          ),
                          child: const Text(
                            'FAILED',
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Colors.transparent,
                    CineColors.background.withValues(alpha: 0.7),
                    CineColors.background,
                  ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: CineColors.success.withValues(alpha: 0.15),
                            borderRadius: BorderRadius.circular(12),
                          ),
                          child: Text(
                            '$episodeCount episode${episodeCount > 1 ? 's' : ''} downloaded',
                            style: const TextStyle(
                              color: CineColors.success,
                              fontSize: 11,
                              fontWeight: FontWeight.w600,
                            ),
                          ),
...
class _EpisodeTile extends ConsumerWidget {
      ...
      return Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            ...
            backgroundColor: CineColors.surfaceVariant,
  ...
  static Color _statusColor(String status) => switch (status) {
        DownloadStatus.downloading => CineColors.info,
        DownloadStatus.completed => CineColors.success,
        DownloadStatus.failed => CineColors.error,
        DownloadStatus.paused => CineColors.warning,
        _ => CineColors.textSecondary,
      };
