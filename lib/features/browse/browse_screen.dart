/// CineStream — Browse / Search screen.
///
...
class _SortButton extends ConsumerWidget {
    ...
    return PopupMenuButton<SearchSortOrder>(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: CineColors.divider),
          borderRadius: BorderRadius.circular(16),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Icons.sort_rounded, size: 14, color: CineColors.textSecondary),
  ...
  PopupMenuItem<SearchSortOrder> _sortItem(
    ...
    return PopupMenuItem(
      ...
      child: Row(
        children: [
          Icon(icon, size: 16, color: CineColors.textSecondary),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: isSearching
              ...
              : const Icon(Icons.search_rounded, color: CineColors.textSecondary),
    ...
    return Container(
      ...
      child: Center(
        child: Icon(
          Icons.movie_rounded,
          size: 40,
          color: CineColors.textTertiary.withValues(alpha: 0.5),
        ),
      ),
    );
  }
