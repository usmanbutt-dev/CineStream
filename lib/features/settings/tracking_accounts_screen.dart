/// CineStream — Tracking Accounts screen.
///
          ...
          Padding(
            ...
            child: Container(
              ...
              child: const Text(
                ...
                'Once configured, CineStream uses OAuth — no password is ever '
        ...
        actions: [
          ...
          FilledButton(
            style: FilledButton.styleFrom(
              backgroundColor: CineColors.error,
            ),
            onPressed: () {
              Navigator.pop(ctx);
              onConfirm();
            ...
            if (isLoading)
              ...
              OutlinedButton(
                style: OutlinedButton.styleFrom(
                  foregroundColor: CineColors.error,
                  side: const BorderSide(color: CineColors.error),
          ...
          Row(
            children: [
              const Icon(Icons.sync_rounded,
                  color: CineColors.primary, size: 20),
...
class _ErrorBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: CineColors.error.withValues(alpha: 0.12),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(color: CineColors.error.withValues(alpha: 0.3)),
      ),
      child: Row(
        children: [
          const Icon(Icons.error_outline_rounded,
              color: CineColors.error, size: 18),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
              message,
